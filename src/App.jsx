...
import AuthForm from './AuthForm';           // The UI component we created earlier
import logoImg from './assets/vigneshwara-logo.png'; 

// 1. CSS Styles (Kept your original styles)
const styles = `
  ...
  .auth-wrapper { display: flex; justify-content: center; align-items: center; min-height: 100vh; background: #f4f4f4; }
...
export default function App() {
  ...
  return (
    <div className="app-container">
      ...
      {/* 3. SWITCHING LOGIC: If no session, show login form */}
      {!session ? (
        ...
        <>
          ...
          <header className="hero">
            ...
            <p style={{ color: '#2a9d8f', fontSize: '0.8rem' }}>Admin: {session.user.email}</p>
          </header>
